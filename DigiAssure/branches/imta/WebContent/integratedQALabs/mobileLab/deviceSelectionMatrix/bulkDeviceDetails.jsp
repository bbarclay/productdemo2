...
<title>Digiassure | Excel Import </title>
...
<!-- START WIDGETS -->                    
	...
	<div class="marginTop50px"></div>
		<div class="top-bar">
			<a href=""></a>
			<div class="font24px">
				<label>Add Device Details</label>
			</div>
...
<div class="col-md-6">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading ui-draggable-handle">
                                    <h3 class="panel-title">Excel Upload</h3>
                                                 <a href="getDeviceDetailTemplate"><button type="button" class="btn btn-primary pull-right" title="Download Template">
							...
							<form action="importDeviceDetails" enctype="multipart/form-data"  method="POST">
	...
	<br><center>
<input type="submit" value="Import"  class="btn btn-success   txtCenter">
</center>
		</form>
                                </div>
