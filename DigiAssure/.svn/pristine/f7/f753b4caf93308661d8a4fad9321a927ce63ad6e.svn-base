...
var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="'+b+'/css/theme-default.css"><img src="'+b+'/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="'+b+'/css/theme-brown.css"><img src="'+b+'/img/themes/brown.jpg"/></a>'
            +'<a href="#" data-theme="'+b+'/css/theme-blue.css"><img src="'+b+'/img/themes/blue.jpg"/></a>'                        
            +'<a href="#" data-theme="'+b+'/css/theme-white.css"><img src="'+b+'/img/themes/light.jpg"/></a>'            
            +'<a href="#" data-theme="'+b+'/css/theme-lightBlue.css"><img src="'+b+'/img/themes/lightBlue.jpg"/></a>'
        +'</div>'
