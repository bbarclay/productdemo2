...
function requestApproval(status,reservationid,vendor){
...
var table=document.getElementById('requestTable');
			...
			for(var i=0; i<rowLength; i+=1){
				  ...
				  var cell = row.cells[8].innerHTML;
		...
		<thead>
			...
			<c:forEach items="${deviceRequests }" var="request">
				<tr>
					...
					<td>
						<button
							onclick="return requestApproval('Approved','${request.reservationid }','${request.vendor }')" class="btn btn-info btn-block">Approve</button>
					</td>
					<td>
						<button
							onclick="return requestApproval('Declined','${request.reservationid }','${request.vendor }')" class="btn btn-danger btn-block">Reject</button>
					</td>
