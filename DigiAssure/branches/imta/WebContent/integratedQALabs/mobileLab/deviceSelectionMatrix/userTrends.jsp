	...
	<div class="container">
						...
						<c:if test="${marketData.marketid == market }">
					 	 ...
					 	 <ul class="dropdown-menu">
				           ...
				           <c:forEach var="monthNames" items="${monthsdata}"  >
							...
							<li class="dropdown-submenu"><a href="#">Yearly</a></li>
							<ul class="dropdown-menu">


								<li><a
									href="../../mobileLab/deviceSelectionMatrix/marketTrends?market=${marketData.marketid}">Current
										Year</a>
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-6 graphPartition">
					<h3 class="labelForGraph">App Usage Distribution By Android
						Version</h3>
				...
				<div class="col-md-6 col-lg-6">
					<div class="marginTop15px"></div>
					<h3 class="labelForGraph">App Usage Distribution By iOS
						Version</h3>
