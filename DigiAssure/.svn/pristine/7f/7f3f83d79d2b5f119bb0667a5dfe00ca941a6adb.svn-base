...
<body onload="changeAccordion('customerRelationshipManagementTesting','digitalQAService')">
				...
				<div class="col-sm-8 col-md-9 verticalLine">
					<div class="marginTop65px">
						<div class="page-header">
							<h1 class="greyTextColor">Customer Relationship Management - Coming Soon</h1>
						</div>
