...
<body onload="changeAccordion('paymentDevice','integratedQALabs')">
	...
	<div>
		...
		<div class="container">
			<div class="">
				...
				<div class="col-sm-8 col-md-9 verticalLine" style="">
					<div class="marginTop65px">
					
						<!-- <h2>Work in progress</h2> -->
						<div class="page-header">
							<h1 class="greyTextColor">Payment Device</h1>
						</div> 
								...
								<div class="panel-body">
									<ul>
										...
										<li>In case you don't have mobile lab cloud login
											credentials, please contact us via <a onclick="sendMail()">
